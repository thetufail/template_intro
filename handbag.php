...
$products_tags = "SELECT * FROM products INNER JOIN products_tags ON products.product_id=products_tags.product_id";
$result = $conn->query($products_tags);
          ...
          <aside class="aa-sidebar">
            ...
            <div class="aa-sidebar-widget">
              ...
              <div class="aa-color-tag">
                ...
                <a class="aa-color-blue" href="blue.php"></a>
                <a class="aa-color-orange" href="red.php"></a>
